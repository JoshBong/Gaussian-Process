...
Original file is located at
    https://colab.research.google.com/drive/1nLsIhKIcjFNCMBTM04dsQmXrfV3S3fUG

**Using array.reshape(-1, 1):** This reshapes your 1D array into a 2D array with one column and as many rows as necessary. This is typically used when you have a single feature (ie: SMILES strings) and multiple samples.

**Using array.reshape(1, -1):** This reshapes your 1D array into a 2D array with one row and as many columns as necessary. This is used when you have a single sample that is described by multiple features.
"""
